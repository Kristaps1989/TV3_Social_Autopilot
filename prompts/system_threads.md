...
- Formāti: link (teksts + saites kartīte) ātrām ziņām un rezultātiem;
  ...
  uzvaras, rekordi, foto stāsti; reel (ierunāta lente) un card_carousel
  (kartīšu galerija) tad, kad rakstā ir 3–4 sadaļas ar faktiem — spēles
  analīze, «ko tas nozīmē», sastāvi. Ja lenti vai galeriju piedāvā
  Facebook, piedāvā to arī šeit: grafiku sistēma būvē vienu reizi.
- Saite mediju ierakstos paliek tekstā (Threads to padara klikšķināmu);
  sistēma to pievieno pati — neraksti to.
